...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        internal override void RefreshAssetList()
        {
            ...
            AssetBundleBrowserMain.instance.m_ManageTab._dependencyInfo?.Clear();
        ...
        private void GatherDependencies(AssetInfo asset, string parentBundle = "")
        {
            ...
            foreach (var ai in deps)
            {
                ...
                bool aiAndAsset = ai == asset;
                bool concrete = m_ConcreteAssets.Contains(ai);
                bool dependent = m_DependentAssets.Contains(ai);
                ...
                {
                    AssetBundleBrowserMain.instance.m_ManageTab._dependencyInfo.Add(new AssetBundleManageTab.DependencyInfoData(asset.fullAssetName, ai.fullAssetName, m_Name.shortName, bundleName));
