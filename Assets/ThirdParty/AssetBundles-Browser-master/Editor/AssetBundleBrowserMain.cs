...
namespace AssetBundleBrowser
{
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        internal STZAssetBuilderTab m_STZBuilderTab;
        [SerializeField]
        internal STZAssetConfigTab m_STZConfigTab;
        ...
        private void OnEnable()
        {
            ...
            if (m_STZBuilderTab == null)
            {
                m_STZBuilderTab = new STZAssetBuilderTab();
            }
            m_STZBuilderTab.OnEnable(this);
            if (m_STZConfigTab == null)
            {
                m_STZConfigTab = new STZAssetConfigTab();
            }
            m_STZConfigTab.OnEnable(this);
        ...
        private void OnGUI()
        {
            ...
            switch (m_Mode)
            {
                ...
                case Mode.Inspect:
                    ...
                    break;
                case Mode.STZBuild:
                    m_STZBuilderTab.OnGUI();
                    break;
                case Mode.STZConfig:
                    m_STZConfigTab.OnGUI();
                    break;
                case Mode.Browser:
                default:
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[5] { "Configure", "Build", "Inspect", "STZBuild", "STZConfig" };
        ...
        /// DrawUILine color
        /// </summary>
        private static Color _lineColor = new Color(0.5f, 0.5f, 0.5f, 0.25f);

        /// <summary>
        /// DrawUILine
        /// </summary>
        /// <param name="inThickness"></param>
        /// <param name="Padding"></param>
        public static void DrawUILine(int inThickness = 1, int Padding = 3)
        {
            Rect r = EditorGUILayout.GetControlRect(GUILayout.Height(Padding + inThickness));
            r.height = inThickness;
            r.y += Padding / 2;
            r.x -= 2;
            r.width += 6;
