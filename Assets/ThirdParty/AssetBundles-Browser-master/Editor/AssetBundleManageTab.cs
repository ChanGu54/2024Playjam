...
namespace AssetBundleBrowser
{
    ...
    internal class AssetBundleManageTab 
    {
        ...
        public List<DependencyInfoData> _dependencyInfo;

        public struct DependencyInfoData
        {
            public string assetFullname;
            public string aiFullName;

            public string checkSelectAssetName;
            public string dependencyAssetName;
            public DependencyInfoData(string assetName, string aiName, string checkName, string otherName)
            {
                assetFullname = assetName;
                aiFullName = aiName;
                checkSelectAssetName = checkName;
                dependencyAssetName = otherName;
            }
        }
        ...
        internal void OnEnable(Rect pos, EditorWindow parent)
        {
            ...
            _dependencyInfo = new List<DependencyInfoData>();
        }
        ...
        internal void UpdateSelectedBundles(IEnumerable<AssetBundleModel.BundleInfo> bundles)
        {
            ...
            m_MessageList.SetBundleListItem(bundles);
