...
namespace E7.NotchSolution
{
    ...
    public class SafePadding : NotchSolutionUIBehaviourBase
    {
        protected override void UpdateRect()
        {
            ...
            // @NOTE byunggeon 맵툴은 Window build 이기 때문에 safe padding이 적용되면 안됨 
            if (!UnityEngine.SceneManagement.SceneManager.GetActiveScene().name.Contains("MaptoolScene"))
            {
